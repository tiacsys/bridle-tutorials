...
.. admonition:: Wissenswertes
   ...
   Die :ref:`Zephyr GPIO API <zephyr:gpio_api>` unterstützt so gut wie all
   üblichen elektrischen Eigenschaften digitaler Ein- und Ausgänge. Das
   ...
   *Assert-Level-High* für den logischen Wert '1', *Assert-Level-Low*
   für den logischen Wert '1' (Negation) und spezielle Funktionen wie
   *Disconnected*, *Init-High* oder *Init-Low* und *Driver-Strength*.

   Alle diese Eigenschaften sind für jedes einzelne GPIO in einem System
   durch das Shell Kommando :bcy:`gpio` zugänglich.
